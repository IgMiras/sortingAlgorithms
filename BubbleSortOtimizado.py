...
def optimized_bubble_sort(tipo_lista, num):
...
for tamanho in tamanho_entrada:
    ...
    optimized_bubble_sort("aleatoria", tamanho)
...
ax.set_title("Bubble Sort Otimizado com Entrada Aleatoria")
...
for tamanho in tamanho_entrada:
    inicio = timeit.default_timer()
    optimized_bubble_sort("crescente", tamanho)
    fim = timeit.default_timer()
    duracao = fim - inicio
    tempo_execucao.append(duracao)
...
fig, ax = plt.subplots()
ax.bar(tamanho_entrada, tempo_execucao, width=2000)
ax.set_title("Bubble Sort Otimizado com Entrada Crescente")
ax.set_xlabel("Tamanho da Entrada")
ax.set_ylabel("Tempo de Execucao")
plt.show()
tempo_execucao.clear()
...
for tamanho in tamanho_entrada:
    inicio = timeit.default_timer()
    optimized_bubble_sort("decrescente", tamanho)
    fim = timeit.default_timer()
    duracao = fim - inicio
    tempo_execucao.append(duracao)
...
fig, ax = plt.subplots()
ax.bar(tamanho_entrada, tempo_execucao, width=2000)
ax.set_title("Bubble Sort Otimizado com Entrada Decrescente")
ax.set_xlabel("Tamanho da Entrada")
ax.set_ylabel("Tempo de Execucao")
plt.show()
tempo_execucao.clear()
